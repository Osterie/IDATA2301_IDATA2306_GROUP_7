...
/**
 * Controller responsible for managing flight company images.
 * Provides endpoints to fetch images and logos of flight companies.
 */
@RestController
...
public class ImageController {
   ...
   */
  @Operation(summary = "Get company banner image", description = "Returns the banner image (JPEG) for the flight company with the specified ID.")
  @ApiResponses({
   ...
   */
  @Operation(summary = "Get company logo image", description = "Returns the logo image (PNG) for the flight company with the specified ID.")
  @ApiResponses({
